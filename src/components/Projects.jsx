...
const Projects = ({ scrollProgress }) => {
    ...
    // PHASE 8: 0.68 -> 0.80
    const containerOpacity = useTransform(scrollProgress, [0.68, 0.71, 0.76, 0.80], [0, 1, 1, 0]);
    const containerY = useTransform(scrollProgress, [0.68, 0.71, 0.76, 0.80], ['-120%', '0%', '0%', '130%']);
