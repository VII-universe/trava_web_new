...
const Expeditions = ({ scrollProgress }) => {
    ...
    const backgroundY = useTransform(scrollProgress, [0.28, 0.31, 0.40, 0.44], ["-100%", "0%", "0%", "130%"]);
    const contentY = useTransform(scrollProgress, [0.28, 0.31, 0.40, 0.44], ["-100%", "0%", "0%", "130%"]);
