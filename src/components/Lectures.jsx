...
const Lectures = ({ scrollProgress }) => {
    ...
    // Lightens the background — fully white before container starts fading so no dark flash
    const lightenOpacity = useTransform(scrollProgress, [0.67, 0.69], [0, 1]);

    const lectCarouselRef = useRef(null);
    const lectCarouselProgress = useTransform(scrollProgress, [0.65, 0.67], [0, 1]);
    useEffect(() => {
