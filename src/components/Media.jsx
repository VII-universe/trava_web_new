...
const Media = ({ scrollProgress }) => {
    ...
    useScrollLock(activeItem || readingArticle);
    ...
    return (
        ...
        >
            <div className="relative z-10 max-w-7xl w-full px-0 md:px-12 mx-auto pointer-events-auto flex flex-col justify-center h-full origin-center transition-transform duration-300 md:translate-y-12 [@media(max-width:767px)]:scale-[0.72] [@media(max-height:850px)_and_(min-width:768px)]:scale-[0.85] [@media(max-height:750px)_and_(min-width:768px)]:scale-[0.75] [@media(max-height:650px)_and_(min-width:768px)]:scale-[0.65]">
